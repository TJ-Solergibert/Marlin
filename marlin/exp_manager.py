...
# NOTE(tj.solergibert) Similar to the original `exp_manager` in NeMo but deactivating the creation of custom logging files and directories for each run
...
class CallbackParams:
    ...
    save_nemo_on_train_end: Optional[bool] = True  # Whether to automatically save .nemo file during on_train_end hook
...
def exp_manager(trainer: "lightning.pytorch.Trainer", cfg: Optional[Union[DictConfig, Dict]] = None) -> Optional[Path]:
    ...
    get_envbool(NEMO_ENV_VARNAME_TESTING, False)
