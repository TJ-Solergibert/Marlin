...
PATH_TO_PREPROCESSING_METADATA=$MARLIN_DIR/datasets/fineweb-2
PATH_TO_DATATROVE_LOGGING_DIR=$MARLIN_DIR/logs/datatrove
PATH_TO_SLURM_LOGGING_DIR=$MARLIN_DIR/logs/slurm/tokenization-$TOKENIZER_NAME-$DATASET_NAME
...
ln -s $DATASET_OUTPUT_FOLDER_NAME $PATH_TO_PREPROCESSING_METADATA/tokenized-dir-link
