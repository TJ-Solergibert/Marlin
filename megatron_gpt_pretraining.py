...
# NOTE(tj.solergibert) Monkeypatch SEE DOCS
from marlin import (
...
from marlin import MarlinCallback, MarlinSignalHandler, exp_manager
...
def main(cfg) -> None:
    ...
    if (cfg.get("run", {}) or {}).get("create_marlin_callback", True):
        # Add Marlin Callback
        trainer.callbacks.append(MarlinCallback(cfg))
        # Add custom signal handler
        trainer._signal_connector = MarlinSignalHandler(trainer)
